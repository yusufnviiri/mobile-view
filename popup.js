...
var mobileDetail = document.querySelector(".mobileDetail");
var desktopDetail = document.querySelector(".desktop");
...
function createWindow(index) {
  ...
  portfolio[index].technologies.forEach(function (technology) {
...
var mobImg = document.querySelector(".mobImag");
...
function createWindowMobile(index) {
  ...
  liveLinkM.href = liveButton1;
  sourceLinkM.href = codeButton1;
}
...
(mobList2.innerHTML = ListItems.itemB), (mobList3.innerHTML = ListItems.itemC);
